<header id="gnav-header-inner"
            class="global-enhancements-header wt-display-flex-xs wt-justify-content-space-between wt-align-items-center wt-width-full wt-body-max-width wt-pl-xs-2 wt-pr-xs-2 wt-pl-lg-6 wt-pr-lg-6 wt-bb-xs wt-bb-lg-none gnav-header-inner wt-pt-lg-2 wt-pb-lg-2"
            role="banner">
            <div class="wt-pb-xs-1 wt-pb-lg-0 wt-pt-sm-1 wt-pt-lg-0 wt-pr-xs-0 wt-pr-sm-1">
                <a href="{{route('home')}}">
                    ...
                    <span class="etsy-icon wt-display-block wt-fill-orange wt-nudge-r-3 wt-nudge-t-1 logo-dimensions"
                        id="logo">
                        <svg xmlns="" viewBox="0 0 48 24" aria-hidden="true"
                            focusable="false">
                            <path
            ...
            <div class="wt-width-full wt-display-flex-xs wt-pr-lg-3 wt-flex-lg-1 order-mobile-tablet-2">
                <button
                    class="wt-btn wt-btn--transparent wt-btn--icon wt-hide-lg wt-btn--transparent-flush-left wt-mb-xs-2 wt-mb-lg-0"
                ...
                <div class="wt-display-inline-block wt-flex-xs-1 wt-pl-lg-0 wt-mb-xs-2 wt-mb-lg-0">
                    <form id="gnav-search"
                        ...
                        <div class="wt-menu wt-menu--full-width wt-menu--offset-below-trigger">
                            <div class="wt-input-btn-group global-enhancements-search-input-btn-group wt-menu__trigger emphasized_search_bar emphasized_search_bar_grey_bg"
                                aria-expanded="false">
           
                                <input id="global-enhancements-search-query" type="text" name="name" class="wt-input wt-input-btn-group__input global-enhancements-search-input-btn-group__input
                              wt-pr-xs-7
                              " >
                                <button type="submit" class="wt-btn wt-btn--transparent wt-btn--icon wt-btn--small wt-position-absolute wt-position-right wt-z-index-9 wt-animated  wt-animated--is-hidden
                              search-close-btn-margin-right">
                                    ...
                                    <span class="wt-icon wt-icon--smaller wt-nudge-t-1">
                                        <svg xmlns="" viewBox="0 0 24 24" aria-hidden="true"
                                            focusable="false">
                                            <path
                            ...
                            <div id="global-enhancements-search-suggestions"
                                class="wt-menu__body wt-menu__body--will-animate global-nav-menu__body wt-width-full wt-max-width-full">
                            </div>
                        </div>
            ...
            <a class="global-enhancements-skip-to-content wt-screen-reader-only wt-focusable" tabindex="1"
                href="https://www.etsy.com/c/art-and-collectibles/painting#content">
                <div
            ...
            <div class="wt-flex-shrink-xs-0">
                <nav aria-label="Main">
                    <ul
                        ...
                        <li>
                            <a   class="wt-btn wt-btn--small wt-btn--transparent wt-mr-xs-1 inline-overlay-trigger signin-header-action select-signin"
                                            href="{{ route('users.authenticate.getLoginUser') }}"> Sign in
                                            </a>
                        ...
                        <li data-favorites-nav-container="">
                            <span class="wt-tooltip wt-tooltip--disabled-touch" data-wt-tooltip="">
                                <a href="https://www.etsy.com/guest/favorites?ref=hdr-fav"
                                    class="wt-tooltip__trigger wt-tooltip__trigger--icon-only wt-btn wt-btn--transparent wt-btn--icon reduced-margin-xs"
                        ...
                        <li>
                            <span class="wt-tooltip wt-tooltip--bottom-left wt-tooltip--disabled-touch"
                                ...
                                <a aria-label="Cart"  href="{{ route('home.productcart') }}"
                                    class="wt-tooltip__trigger wt-tooltip__trigger--icon-only wt-btn wt-btn--transparent wt-btn--icon">
                                    <span
                                        class="wt-z-index-1 wt-no-wrap wt-display-none ge-cart-badge wt-badge wt-badge--notification-03 wt-badge--small wt-badge--outset-top-right"
                        ...
                        <li>
                            <a   class="wt-btn wt-btn--small wt-btn--transparent wt-mr-xs-1 inline-overlay-trigger signin-header-action select-signin"
                                            href="{{ route('admin.authenticate.logoutUse') }}"> Logout
                                            </a>
