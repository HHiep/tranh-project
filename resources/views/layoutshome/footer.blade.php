    ...
    <div class=" wt-bg-denim-tint">
        <div data-appears-component-name="impact_message"
            ...
            <div class="footer-impact-callout wt-position-relative appears-ready">
                <span
                    class="wt-edge wt-fill-denim-light wt-edge--smaller wt-nudge-t-4 wt-edge--top wt-edge--ratio-none"
                    direction="top" aria-hidden="true">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1400 48" preserveAspectRatio="none"
                ...
                <span
                    class="wt-edge wt-fill-denim-light wt-edge--smaller wt-nudge-t-4 wt-edge--top wt-edge--ratio-slice"
                    direction="top" aria-hidden="true">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1400 48"
                ...
                <div
                    class="wt-bg-denim-light wt-text-white wt-text-center-xs wt-text-body-01 wt-pb-xs-2 wt-pt-xs-2">
                    <div class="wt-popover wt-popover--top" data-wt-popover="">
                        ...
                        <div id="footer-environmental-impact-popover-content" role="tooltip">
                            Etsy’s 100% renewable electricity commitment includes the electricity used by the
                            data centers that host Etsy.com, the Sell on Etsy app, and the Etsy app, as well as
                            the electricity that powers Etsy’s global offices and employees working remotely
                            from home in the US.
        ...
        <nav aria-label="Footer"
            class="wt-pt-xs-2 wt-pt-md-6 wt-pr-xs-4 wt-pb-md-4 wt-pl-xs-4 wt-text-caption wt-bg-denim wt-text-white"
            data-footer-extra-links="">
            <div class="wt-body-max-width">
                <div class="wt-grid">
                    <div class="wt-mb-xs-2 wt-grid__item-md-3">
                        ...
                        <button type="button"
                            class="wt-hide-md wt-content-toggle--btn wt-width-full wt-btn wt-btn--transparent wt-btn--light wt-content-toggle--with-icon wt-content-toggle--flush wt-text-white wt-mb-xs-1"
                            data-wt-content-toggle="" aria-controls="footer-extra-links-630ddfa28c147"
                            aria-expanded="false">
                        ...
                        <div id="footer-extra-links-630ddfa28c147" class="wt-content-toggle__body"
                            aria-hidden="false">
                            <ul class="wt-list-unstyled wt-text-left-xs wt-pl-xs-1 wt-pl-sm-0 wt-pr-xs-1">
                                <li class="wt-pt-xs-1 wt-pb-xs-2 wt-pb-md-1 wt-display-block wt-width-full ">
                                    <a class="appshell-responsive-footer-link wt-text-white wt-text-link-no-underline"
                    ...
                    <div class="wt-mb-xs-2 wt-grid__item-md-3">
                        ...
                        <button type="button"
                            class="wt-hide-md wt-content-toggle--btn wt-width-full wt-btn wt-btn--transparent wt-btn--light wt-content-toggle--with-icon wt-content-toggle--flush wt-text-white wt-mb-xs-1"
                            data-wt-content-toggle="" aria-controls="footer-extra-links-630ddfa28c191"
                            aria-expanded="false">
                            <span class="wt-text-title-01 wt-text-left-xs wt-flex-xs-auto wt-width-full">
                                Sell
                            </span>
                        ...
                        <div id="footer-extra-links-630ddfa28c191" class="wt-content-toggle__body"
                            aria-hidden="false">
                            <ul class="wt-list-unstyled wt-text-left-xs wt-pl-xs-1 wt-pl-sm-0 wt-pr-xs-1">
                                <li class="wt-pt-xs-1 wt-pb-xs-2 wt-pb-md-1 wt-display-block wt-width-full ">
                                    <a class="appshell-responsive-footer-link wt-text-white wt-text-link-no-underline"
                    ...
                    <div class="wt-mb-xs-2 wt-grid__item-md-3">
                        ...
                        <button type="button"
                            class="wt-hide-md wt-content-toggle--btn wt-width-full wt-btn wt-btn--transparent wt-btn--light wt-content-toggle--with-icon wt-content-toggle--flush wt-text-white wt-mb-xs-1"
                            data-wt-content-toggle="" aria-controls="footer-extra-links-630ddfa28c1b5"
                            aria-expanded="false">
                            <span class="wt-text-title-01 wt-text-left-xs wt-flex-xs-auto wt-width-full">
                                About
                            </span>
                        ...
                        <div id="footer-extra-links-630ddfa28c1b5" class="wt-content-toggle__body"
                            aria-hidden="false">
                            <ul class="wt-list-unstyled wt-text-left-xs wt-pl-xs-1 wt-pl-sm-0 wt-pr-xs-1">
                                <li class="wt-pt-xs-1 wt-pb-xs-2 wt-pb-md-1 wt-display-block wt-width-full ">
                                    <a class="appshell-responsive-footer-link wt-text-white wt-text-link-no-underline"
                    ...
                    <div class="wt-mb-xs-2 wt-grid__item-md-3">
                        ...
                        <button type="button"
                            class="wt-hide-md wt-content-toggle--btn wt-width-full wt-btn wt-btn--transparent wt-btn--light wt-content-toggle--with-icon wt-content-toggle--flush wt-text-white wt-mb-xs-1"
                            data-wt-content-toggle="" aria-controls="footer-extra-links-630ddfa28c306"
                            aria-expanded="false">
                            <span class="wt-text-title-01 wt-text-left-xs wt-flex-xs-auto wt-width-full">
                                Help
                            </span>
                        ...
                        <div id="footer-extra-links-630ddfa28c306" class="wt-content-toggle__body"
                            aria-hidden="false">
                            <ul class="wt-list-unstyled wt-text-left-xs wt-pl-xs-1 wt-pl-sm-0 wt-pr-xs-1">
                                <li class="wt-pt-xs-1 wt-pb-xs-2 wt-pb-md-1 wt-display-block wt-width-full ">
                                    <a class="appshell-responsive-footer-link wt-text-white wt-text-link-no-underline"
                        ...
                        <div class="wt-width-full">
                            <div class="wt-text-center-xs wt-text-left-md wt-mt-xs-2">
                                <a href="https://etsy.app.link/d7nDUdp49V"
                                    ...
                                    rel="nofollow">
                                    <span class="etsy-icon wt-flex-shrink-xs-0">
                                ...
                                <ul
                                    class="wt-list-inline wt-mt-xs-3 wt-mb-xs-4 wt-mb-sm-0 wt-pl-xs-0 wt-pr-xs-0 wt-pl-sm-0 wt-pr-sm-0">
                                    <li class="wt-list-inline__item">
                                        <a class="wt-btn wt-btn--transparent wt-btn--transparent-flush-left wt-btn--light wt-btn--icon wt-p-xs-1"
                                            href="https://www.etsy.com/social-tracking?network=instagram"
                                            rel="nofollow" target="_blank">
                                            <span class="etsy-icon wt-icon--larger">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                    aria-hidden="true" focusable="false">
                                                    <path
                                    ...
                                    <li class="wt-list-inline__item">
                                        <a class="wt-btn wt-btn--transparent wt-btn--transparent-flush-left wt-btn--light wt-btn--icon wt-p-xs-1"
                                            href="https://www.etsy.com/social-tracking?network=facebook"
                                            rel="nofollow" target="_blank">
                                            <span class="etsy-icon wt-icon--larger">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                    aria-hidden="true" focusable="false">
                                    ...
                                    <li class="wt-list-inline__item">
                                        <a class="wt-btn wt-btn--transparent wt-btn--transparent-flush-left wt-btn--light wt-btn--icon wt-p-xs-1"
                                            href="https://www.etsy.com/social-tracking?network=pinterest"
                                            rel="nofollow" target="_blank">
                                            <span class="etsy-icon wt-icon--larger">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                    aria-hidden="true" focusable="false">
                                    ...
                                    <li class="wt-list-inline__item">
                                        <a class="wt-btn wt-btn--transparent wt-btn--transparent-flush-left wt-btn--light wt-btn--icon wt-p-xs-1"
                                            href="https://www.etsy.com/social-tracking?network=twitter"
                                            rel="nofollow" target="_blank">
                                            <span class="etsy-icon wt-icon--larger">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                    aria-hidden="true" focusable="false">
                                    ...
                                    <li class="wt-list-inline__item">
                                        <a class="wt-btn wt-btn--transparent wt-btn--transparent-flush-left wt-btn--light wt-btn--icon wt-p-xs-1"
                                            href="https://www.etsy.com/social-tracking?network=youtube"
                                            rel="nofollow" target="_blank">
                                            <span class="etsy-icon wt-icon--larger">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                    aria-hidden="true" focusable="false">
                ...
                <div class="wt-grid wt-body-max-width wt-display-flex-lg">
                    <div class="wt-grid__item-lg-5 wt-text-left-lg wt-text-center-xs wt-pb-xs-2 wt-pb-xl-0">
                        <a id="locale-picker-trigger"
                            ...
                            aria-label="Update your settings Vietnam English (US) ₫ (VND)"
                            href="https://www.etsy.com/your/account/locale_preferences?from_page=https%3A%2F%2Fwww.etsy.com%2Fc%2Fart-and-collectibles%2Fpainting"
                            ...
                            <span class="wt-display-inline-block wt-vertical-align-middle">&nbsp; Vietnam &nbsp;
                                | &nbsp; English (US) &nbsp; | &nbsp; ₫ (VND)</span>
                        </a>
                    </div>
                    <div
                        ...
                        <span
                            class="wt-text-caption  wt-text-white wt-mr-sm-2 wt-mb-xs-2 wt-mb-sm-0 wt-display-inline-block">
                            © 2022 Etsy, Inc.
                        </span>
                        <ul
                            class="wt-list-inline wt-display-inline-block wt-text-caption wt-ml-md-2 wt-mb-xs-0">
                            <li class="wt-list-inline__item wt-mr-md-3">
                                <a href="https://www.etsy.com/legal/terms-of-use?ref=ftr"
                                    class=" wt-text-white">
                                    Terms of Use
                                </a>
                            </li>
                            <li class="wt-list-inline__item wt-mr-md-3">
                                <a href="https://www.etsy.com/legal/privacy/?ref=ftr" class=" wt-text-white">
                                    Privacy
                                </a>
                            </li>
                            <li class="wt-list-inline__item ">
                                <a href="https://www.etsy.com/legal/policy/cookies-tracking-technologies/44797645975?ref=ftr"
                                    class=" wt-text-white">
                                    Interest-based ads
                                </a>
                            </li>
