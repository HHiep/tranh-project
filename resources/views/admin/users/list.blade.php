    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.users.getList') }}" method="GET">
                            <div class="col-12">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <a class="btn badge badge-gradient-success"
                                                href="{{ route('admin.users.getadd') }}">Add</a>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($users as $index => $user)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($userlist->role == 9 & $userlist->role!= $user->role )
                        ...
                        </div class="ma1"> {{ $users->links('admin.component.pagination') }}
                    </div>
                </div>
            </div>
        </div>
