                ...
                <div class="row flex-grow">
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left p-5">
                            ...
                            <form class="pt-3" action="{{ route('admin.authenticate.postLogin') }}" method="POST">
                                @csrf
                                <div class="form-group">
                                    <input type="text" name="email" class="form-control form-control-lg"
                                        id="exampleInputEmail1" placeholder="Tài khoản" value="{{ $email }}">
                                    @error('email')
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class=" form-group input-group">
                                        <a class=" col-12 btn  btn badge-gradient-info" href="{{route('forgotPassword')}}">Quên mật khẩu
                                        </a>
                                    </div>
                                    <div class=" form-group input-group">
                                        <a class=" col-12 btn  btn badge-gradient-success"
